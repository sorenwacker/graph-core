    ...
    <div ref="graphControlsRef" class="graph-controls">
      ...
      <div class="layout-settings-wrapper">
        ...
        <div v-if="showLayoutSettings" class="layout-settings-dropdown">
          ...
          <div class="layout-setting"><label>Edge Length: {{ radialSettings.edgeLength }}</label><input type="range" v-model.number="radialSettings.edgeLength" min="20" max="1000" step="10"/></div>
