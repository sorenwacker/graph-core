    ...
    <div class="detail-panel-header">
      <div class="header-controls">
        <button
          ...
          @click="
            editedNode.favorite = !editedNode.favorite
            saveChanges()
          "
        ...
        <label v-if="editedNode.type !== 'person'" class="done-checkbox" title="Mark as done">
          <input
            ...
            @change="
              editedNode.completed = $event.target.checked
              saveChanges()
            "
          />
        </label>
      ...
      <textarea
        ...
        rows="1"
        @input="
          editedNode.title = $event.target.value
            ...
            <div v-show="!notesCollapsed" class="section-content">
              <div class="tabs-row">
                ...
                <button
                  ...
                  @click="
                    editedNode.notes_sensitive = !editedNode.notes_sensitive
                    saveChanges()
                  "
                  :title="
