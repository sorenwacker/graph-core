...
function onDocumentClick(e) {
  if (
    ...
    !settingsDropdownRef.value.contains(e.target) &&
...
<template>
  <div class="toolbar">
    ...
    <button ref="redoBtn" class="icon-btn" :disabled="!canRedo" @click="emit('redo')" aria-label="Redo">
      &#x21AA;
    </button>
    <span class="toolbar-separator"></span>
    <button ref="themeBtn" class="icon-btn theme-btn" @click="cycleTheme" aria-label="Toggle theme">
